export default function Testimonials() {
    return (
      <section className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(45rem_50rem_at_top,gray.900,black)] opacity-20" />
        <div className="absolute inset-y-0 right-1/2 -z-10 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] bg-black shadow-xl shadow-white/10 ring-1 ring-gray-800 sm:mr-28 lg:mr-0 xl:mr-16 xl:origin-center" />
          ...
          <figure className="mt-10">
            ...
            <figcaption className="mt-10">
              ...
              <div className="mt-4 flex items-center justify-center space-x-3 text-base">
                ...
                <svg viewBox="0 0 2 2" width={3} height={3} aria-hidden="true" className="fill-gray-100">
